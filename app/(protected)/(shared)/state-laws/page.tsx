      ...
      <div className='mx-auto w-full max-w-6xl'>
        ...
        {stateLaws === undefined ? (
          ...
          <div className='rounded-3xl border border-cream-border bg-cream-surface p-8 text-center'>
            ...
            <p className='mt-2 text-ink-warm-muted'>State laws haven't been populated in the database yet.</p>
          </div>
        ) : filteredStateLaws.length === 0 ? (
          <div className='rounded-3xl border border-cream-border bg-cream-surface p-8 text-center'>
            <p className='font-heading text-2xl text-ink-warm'>No matching states</p>
            <p className='mt-2 text-ink-warm-muted'>Try searching with a different state name or 2-letter code.</p>
          </div>
        ) : (
