...
import { AlertTriangle, CircleHelp, FileText, Gavel, Scale, Search, Shield, TrendingUp, Wrench, X } from 'lucide-react';
...
import { ISSUE_TYPES, type IssueTypeIconKey, type IssueTypeValue } from '@/lib/constants/issue-types';
import { US_STATE_NAMES, type USStateAbbr } from '@/lib/constants/us-states';
import { hasReachedLetterLimit, resolvePlanId, shouldPromptFreePlanUpgrade } from '@/lib/plans/plan-access';
  ...
  return (
    <main className='flex min-h-[100dvh] flex-col bg-cream-page pb-28 pt-5 md:min-h-[calc(100vh-4rem)] md:pb-10 md:pt-6 lg:pt-8'>
      ...
      <PlanUpgradeDialog
        ...
        title={upgradeDialogMode === 'free' ? 'Upgrade to generate more letters' : 'Upgrade to write another letter'}
        description={
